...
CREATE TABLE `documento`  (
  ...
  `contenido` blob NULL COMMENT 'Contenido',
  ...
  INDEX `fk_documento_postulacion`(`postulacion_id`) USING BTREE,
  ...
  CONSTRAINT `fk_documento_postulacion` FOREIGN KEY (`postulacion_id`) REFERENCES `postulacion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of documento
-- ----------------------------
INSERT INTO `documento` VALUES (5, 'Consentimiento Alcohol Root Root Root_6.pdf', 0x646F63756D656E746F732F436F6E73656E74696D69656E746F20416C636F686F6C20526F6F7420526F6F7420526F6F745F362E706466, 1, '2019-04-02 14:14:51', 4);
INSERT INTO `documento` VALUES (6, 'Consentimiento Droga Root Root Root_7.pdf', 0x646F63756D656E746F732F436F6E73656E74696D69656E746F2044726F676120526F6F7420526F6F7420526F6F745F372E706466, 2, '2019-04-02 14:14:51', 4);
INSERT INTO `documento` VALUES (7, 'Consentimiento Droga Root Root Root_6.pdf', 0x646F63756D656E746F732F436F6E73656E74696D69656E746F2044726F676120526F6F7420526F6F7420526F6F745F362E706466, 3, '2019-04-02 14:14:51', 4);
INSERT INTO `documento` VALUES (8, '91caa861-e71b-46e1-a4b2-911b285d3b09.pdf', 0x646F63756D656E746F732F39316361613836312D653731622D343665312D613462322D3931316232383564336230392E706466, 4, '2019-04-02 14:14:51', 4);
INSERT INTO `documento` VALUES (9, '6aecb790-5372-4f2a-a9fc-003045ac487b.pdf', 0x646F63756D656E746F732F36616563623739302D353337322D346632612D613966632D3030333034356163343837622E706466, 5, '2019-04-02 14:14:51', 4);
...
INSERT INTO `migration` VALUES ('m190331_102229_alter_table_postulacion_documento', 1554031688);
INSERT INTO `migration` VALUES ('m190402_084458_alter_table_postulacion', 1554194782);
...
CREATE TABLE `postulacion`  (
  ...
  `fecha_creacion` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `estado` tinyint(1) NULL DEFAULT 1 COMMENT 'Estado',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `postulacion` VALUES (4, 20, 15, '2019-04-02 14:14:51', 1);
...
INSERT INTO `reclamacion` VALUES (4, 20, 'ttttt', NULL, '2019-03-31 15:39:06');
...
INSERT INTO `tipodocumento` VALUES (2, 'Biografía', 'Biografía');
INSERT INTO `tipodocumento` VALUES (3, 'Título', 'Título');
INSERT INTO `tipodocumento` VALUES (4, 'Certificado de Nacimiento', 'Certificado de Nacimiento');
INSERT INTO `tipodocumento` VALUES (5, 'Cedula', 'Cedula');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'root', 'root@test.com', '$2y$10$l.H4OYgaIGVL8mcP0dCfj.97min2dXUayOVfWPeaR6RlfFH3PJrcK', 'zxfVmWefHKHG538pNYX83ozdn0uD7qgu', NULL, NULL, 0, 1553703630, NULL, 1553703630, 1553703630, 1554037965, '', 0, 1553703630);
...
INSERT INTO `user` VALUES (20, 'asd', 'asd@asd.cu', '$2y$10$rXDkKrIvi6dREhcNEX5EQOOdY.EUwMuLXq.dX90pwaQEprGJVnNJC', 'Sj3-XyDMc0beMghdGwNXNNHy2iMaYaso', NULL, '::1', 0, 1553938362, NULL, 1553938362, 1553938362, 1554211839, '', 0, 1553938362);
INSERT INTO `user` VALUES (21, 'hhrr', 'hhrr@test.cu', '$2y$10$k5ZXze8r3XhyVVphKRM9auiU4am0LWkBDrLGkAbD2wdeg3SJeGnmi', 'xWOVxrjRxFhMXW6sujfWmz19vlqWo2FQ', NULL, '::1', 0, 1553938424, NULL, 1553938424, 1553938424, 1554211814, '', 0, 1553938424);
